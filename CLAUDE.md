...
```mermaid
graph TD
  83cd222f["ERC-721 NFT"]
  86911802["Frontend"]
  dcdeca29["Wallet Auth"]
  83cd222f --> 86911802
  86911802 --> dcdeca29
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--83cd222f.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--86911802.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--dcdeca29.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--83cd222f.md)
- [Frontend](.nskills/components/frontend-scaffold--86911802.md)
- [Wallet Auth](.nskills/components/wallet-auth--dcdeca29.md)
